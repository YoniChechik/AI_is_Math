...
if 'google.colab' in sys.modules:
    ...
    subprocess.call('svn export https://github.com/YoniChechik/AI_is_Math/trunk/c_05_image_formation/ex5/calib_im1.jpg'.split())
    subprocess.call('svn export https://github.com/YoniChechik/AI_is_Math/trunk/c_05_image_formation/ex5/calib_im2.jpg'.split())
    subprocess.call('svn export https://github.com/YoniChechik/AI_is_Math/trunk/c_05_image_formation/ex5/calib_im3.jpg'.split())
    subprocess.call('svn export https://github.com/YoniChechik/AI_is_Math/trunk/c_05_image_formation/ex5/vignette_im1.jpg'.split())
    subprocess.call('svn export https://github.com/YoniChechik/AI_is_Math/trunk/c_05_image_formation/ex5/vignette_im2.jpg'.split())
    subprocess.call('svn export https://github.com/YoniChechik/AI_is_Math/trunk/c_05_image_formation/ex5/vignette_im3.jpg'.split())
